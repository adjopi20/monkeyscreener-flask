...
@hist_bp.route('/api/histogram-analysis-for-sector/<sector>/<category>', methods=['GET'])
...
@hist_bp.route('/api/histogram-analysis-for-sector-2/<sector>/<metric>', methods=['GET'])
